...
import com.neusoft.acss.column.detail.impl.D_I_EvectionLocale;
import com.neusoft.acss.column.total.IColumnTotal;

public class T_C_EvectionLocale implements IColumnTotal {
	...
	public String generateColumn(Info info) {
		...
		for (Map<String, String> m : list) {
			if (StringUtils.isNotEmpty(m.get(D_I_EvectionLocale.class.getName()))) {
				count++;
			}
		}
		return count + "";
