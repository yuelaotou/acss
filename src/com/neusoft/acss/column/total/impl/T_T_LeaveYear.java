...
import com.neusoft.acss.column.detail.impl.D_T_LeaveYear;
import com.neusoft.acss.column.total.IColumnTotal;

public class T_T_LeaveYear implements IColumnTotal {
	...
	public String generateColumn(Info info) {
		...
		for (Map<String, String> m : list) {
			String time = m.get(D_T_LeaveYear.class.getName());
